...
selectAttributes = "prod, 1_sum_quant, 2_sum_quant, 3_avg_quant"
groupingVars = "3"
groupingAttributes = "prod"
aggregates = "1_sum_quant, 2_sum_quant, 3_avg_quant"
groupingPredicates = "1.month= 1,2.month = 5,3.month = 9"
havingCondition = ""
mf_struct = {}
output = PrettyTable()
